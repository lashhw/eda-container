...
dnf install -y sudo zsh tcsh vim firefox iputils iproute redhat-lsb-core binutils gcc-c++ git ksh \
  xorg-x11-xauth xorg-x11-fonts-* xorg-x11-utils dbus-x11 google-noto-sans-fonts google-noto-sans-cjk-ttc-fonts \
  ...
  libnsl.i686 libXp.i686 libXt.i686 libXtst.i686
